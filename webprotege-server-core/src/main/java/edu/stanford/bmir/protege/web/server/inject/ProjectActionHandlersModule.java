...
public class ProjectActionHandlersModule {
    ...
    @Provides @IntoSet
    public ProjectActionHandler provideCheckOntologyActionHandler(CheckOntologyActionHandler handler) {
        return handler;
    }
    ...
    @Provides @IntoSet
    public ProjectActionHandler provideStopDebuggingActionHandler(StopDebuggingActionHandler handler) {
        return handler;
    }
