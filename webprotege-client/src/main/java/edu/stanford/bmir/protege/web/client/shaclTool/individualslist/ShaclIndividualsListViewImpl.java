 ...
 * 16/02/16
 */
public class ShaclIndividualsListViewImpl extends Composite implements ShaclIndividualsListView {

    private final PaginatorPresenter paginatorPresenter;

    private EntityNodeListCellRenderer renderer;

    interface IndividualsListViewImplUiBinder extends UiBinder<HTMLPanel, ShaclIndividualsListViewImpl> {
    ...
    @Inject
    public ShaclIndividualsListViewImpl(@Nonnull PaginatorPresenter paginatorPresenter,
