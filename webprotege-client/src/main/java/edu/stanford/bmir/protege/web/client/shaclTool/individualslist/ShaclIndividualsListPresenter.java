 ...
 */
public class ShaclIndividualsListPresenter implements EntityNodeIndex {
    ...
    private final ShaclHierarchyFieldPresenter hierarchyFieldPresenter;

    private final Messages messages;

    private final ShaclIndividualsListView view;
    ...
    @Inject
    public ShaclIndividualsListPresenter(ShaclIndividualsListView view,
                                         @Nonnull ProjectId projectId,
                                         final SelectionModel selectionModel,
                                         DispatchServiceManager dispatchServiceManager,
                                         LoggedInUserProjectPermissionChecker permissionChecker,
                                         ShaclHierarchyFieldPresenter hierarchyFieldPresenter,
                                         Messages messages,
    ...
    public void setClassEntity(OWLEntity cls){
        GWT.log("=========================");
        GWT.log(cls.toString());
        String segments[] = cls.toStringID().split("#");
        String clsstr = segments[segments.length - 1];
        OWLEntityData oed = DataFactory.getOWLEntityData(cls, clsstr, ImmutableMap.of());
        hierarchyFieldPresenter.setEntityAndFireEvents(oed);
        updateList();
    }
