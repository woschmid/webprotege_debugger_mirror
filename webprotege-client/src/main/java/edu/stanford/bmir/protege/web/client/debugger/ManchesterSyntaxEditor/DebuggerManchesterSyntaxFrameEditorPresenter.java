...
import edu.stanford.bmir.protege.web.client.frame.ManchesterSyntaxFrameAutoCompletionHandler;
 ...
 */
public class DebuggerManchesterSyntaxFrameEditorPresenter implements HasSubject<OWLEntity>, HasFreshEntities {

    private final DispatchServiceManager dsm;

    private final DebuggerManchesterSyntaxFrameEditor editor;
    ...
    @Inject
    public DebuggerManchesterSyntaxFrameEditorPresenter(DebuggerManchesterSyntaxFrameEditor editor, ProjectId projectId, LoggedInUserProjectPermissionChecker permissionChecker, DispatchServiceManager dispatchServiceManager, LoggedInUserProvider loggedInUserProvider, DispatchErrorMessageDisplay errorDisplay, @Nonnull InputBox inputBox) {
        this.editor = editor;
    ...
    public DebuggerManchesterSyntaxFrameEditor getView() {
        return editor;
    }
