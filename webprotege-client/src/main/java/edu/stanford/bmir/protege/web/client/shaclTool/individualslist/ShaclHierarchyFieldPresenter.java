 ...
 * 12 Sep 2018
 */
public class ShaclHierarchyFieldPresenter {
    ...
    @Inject
    public ShaclHierarchyFieldPresenter(@Nonnull ProjectId projectId,
    ...
    public void setEntityAndFireEvents(@Nonnull OWLEntityData entity) {
        setEntity(entity);
        entityChangedHandler.handleEntityChanged();
    }
