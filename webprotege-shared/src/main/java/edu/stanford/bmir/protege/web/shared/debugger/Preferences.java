...
public class Preferences implements Serializable, IsSerializable {
    ...
    public static Long getSessionKeepaliveInMillis() {
        return SESSION_KEEPALIVE_IN_MILLIS;
    }

    public static Long getReasonerTimeoutInMillis() {
        return REASONER_TIMEOUT_IN_MILLIS;
    }

    public static int getMaxVisiblePossiblyFaultyAxioms() {
        return MAX_VISIBLE_POSSIBLY_FAULTY_AXIOMS;
    }

    public static int getMaxVisibleCorrectAxioms() {
     ...
     */
    public static void setSessionKeepaliveInMillis(Long sessionKeepaliveInMillis) {
     ...
     */
    public static void setMaxVisiblePossiblyFaultyAxioms(int maxVisiblePossiblyFaultyAxioms) {
     ...
     */
    public static void setMaxVisibleCorrectAxioms(int maxVisibleCorrectAxioms) {
